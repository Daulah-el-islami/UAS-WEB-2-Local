        ...
        <div class="card border border-light-subtle rounded-3 shadow-sm">
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="text-center mb-3">
              <a href="#!">
                <img src="/images/logo.png" alt="BootstrapBrain Logo" width="250">
              </a>
            </div>
            <h2 class="fs-4 fw-bold text-center text-secondary mb-4">Daftar</h2>
            <form method="POST" action="{{ route('register.post') }}">
              ...
              <div class="row gy-2 overflow-hidden">
                ...
                <div class="col-12">
                  <p class="m-0 text-secondary text-center">Sudah punya akun? <a href="{{ route('login') }}" class="link-primary text-decoration-none">Login</a></p>
                </div>
              </div>
            </form>
          </div>
